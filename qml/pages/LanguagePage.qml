    ...
    SilicaListView {
        ...
        header: Column {
            ...
            Label {
                ...
                text: qsTr("Wirkt beim nächsten Start der App. Nur Deutsch und Englisch sind geprüft; die übrigen Sprachen sind maschinell übersetzt. Englisch ist hier immer verfügbar.")
            }
